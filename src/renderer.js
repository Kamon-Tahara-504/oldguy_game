...
export class Renderer {
  ...
  initGroundAndWalls(walls) {
    ...
    this.groundGraphics.drawRect(0, this.game.gameConfig.groundY - 10, this.game.gameConfig.width, 20)
    ...
    this.boxTopGraphics.moveTo(0, this.game.gameConfig.boxTopY)
    this.boxTopGraphics.lineTo(this.game.gameConfig.width, this.game.gameConfig.boxTopY)
